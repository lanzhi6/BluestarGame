...
public final class RecipeRegister
{
    ...
    public void registerRecipes()
    {
        ...
        ShapelessRecipe super_sponge=new ShapelessRecipe(super_sponge_key,
        ...
        ShapedRecipe water_sponge=new ShapedRecipe(water_sponge_key,
                                                   plugin.getBluestarGameManager()
                                                         .getSuperSpongeManager()
                                                         .getWaterSponge()
                                                         .getItem());
        water_sponge=water_sponge.shape("a");
        water_sponge=water_sponge.setIngredient('a',
                                                new RecipeChoice.ExactChoice(plugin.getBluestarGameManager()
                                                                                   .getSuperSpongeManager()
                                                                                   .getlavaSponge()
                                                                                   .getItem()));
        ...
        ShapedRecipe lava_sponge=new ShapedRecipe(lava_sponge_key,
                                                  plugin.getBluestarGameManager()
                                                        .getSuperSpongeManager()
                                                        .getlavaSponge()
                                                        .getItem());
        lava_sponge=lava_sponge.shape("a");
        lava_sponge=lava_sponge.setIngredient('a',
                                              new RecipeChoice.ExactChoice(plugin.getBluestarGameManager()
                                                                                 .getSuperSpongeManager()
                                                                                 .getWaterSponge()
                                                                                 .getItem()));
        ...
        FurnaceRecipe used_water_sponge=new FurnaceRecipe(used_water_sponge_key,
                                                          plugin.getBluestarGameManager()
                                                                .getSuperSpongeManager()
                                                                .getWaterSponge()
                                                                .getItem(),
        ...
        FurnaceRecipe used_lava_sponge=new FurnaceRecipe(used_lava_sponge_key,
                                                         plugin.getBluestarGameManager()
                                                               .getSuperSpongeManager()
                                                               .getlavaSponge()
                                                               .getItem(),
        ...
        BlastingRecipe fired_coal_block=new BlastingRecipe(fired_coal_block_key,
                                                           CompressedCoal.FIRED_COAL_BLOCK.getItem(),
                                                           new RecipeChoice.ExactChoice(new ItemStack(Material.COAL_BLOCK)),
                                                           2,
                                                           200);
        ...
        BlastingRecipe fired_compressed_coal=new BlastingRecipe(fired_compressed_coal_key,
