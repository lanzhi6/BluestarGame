...
public class RegisterRecipe
{
    ...
    public static void registerRecipes()
    {
        ...
        FurnaceRecipe usedWatersponge=new FurnaceRecipe(new NamespacedKey(BluestarGame.plugin,"usedwatersponge"),superSponge.getWaterSponge().getItem(),new RecipeChoice.ExactChoice(superSponge.getUsedWaterSponge().getItem()),5,200);
        Bukkit.addRecipe(usedWatersponge);

        /* 使用过的岩浆海绵烧制 */
        recipes.add(new NamespacedKey(BluestarGame.plugin,"usedlavasponge"));
        FurnaceRecipe usedlavasponge=new FurnaceRecipe(new NamespacedKey(BluestarGame.plugin,"usedlavasponge"),superSponge.getlavaSponge().getItem(),new RecipeChoice.ExactChoice(superSponge.getUsedLavaSponge().getItem()),5,200);
